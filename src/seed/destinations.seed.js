...
export const DESTINATIONS_DATA = [{
  "_id": {
    "$oid": "6a22f1322aff6e43a1ad3c54"
  },
  "name": {
    "en": "Great Pyramid of Giza",
    "ar": "الهرم الأكبر بالجيزة"
  },
  ...
  "attractions": [
    ...
    {
      "name": {
        "en": "Solar Boat Museum",
        "ar": "متحف المركب الشمسية"
      },
      "type": "museum",
      "entryFee": 100
    }
...
{
  "_id": {
    "$oid": "6a22f1322aff6e43a1ad3c57"
  },
  "name": {
    "en": "Saqqara Necropolis",
    "ar": "سقارة"
  },
  "slug": "saqqara",
  "city": "Cairo",
...
},
{
  ...
  "attractions": [
    ...
    {
      "name": {
        "en": "Temple of Mentuhotep II",
        "ar": "معبد منتوحوتب الثاني"
      },
      "type": "historical",
      "entryFee": 0
    }
...
},
{
  ...
  "attractions": [
    ...
    {
      "name": {
        "en": "Soviet-Egyptian Friendship Monument",
        "ar": "نصب الصداقة السوفيتية المصرية"
      },
      "type": "landmark",
      "entryFee": 0
    }
...
},
{
  ...
  "attractions": [
    {
      "name": {
        "en": "Main Reading Hall",
        "ar": "قاعة القراءة الرئيسية"
      },
      "type": "cultural",
      "entryFee": 70
    },
...
{
  "_id": {
    "$oid": "6a22f1322aff6e43a1ad3c64"
  },
  "name": {
    "en": "Greco-Roman Museum",
    "ar": "المتحف اليوناني الروماني"
  },
  ...
  "attractions": [
    {
      "name": {
        "en": "Greco-Roman Collection",
        "ar": "المجموعة اليونانية الرومانية"
      },
      "type": "museum",
      "entryFee": 60
    }
...
},
{
  ...
  "attractions": [
    {
      "name": {
        "en": "Wadi el-Rayan Waterfalls",
        "ar": "شلالات وادي الريان"
      },
      "type": "nature",
      "entryFee": 20
    },
    {
      "name": {
        "en": "Upper & Lower Lakes",
        "ar": "البحيرتان العليا والسفلى"
      },
      "type": "nature",
      "entryFee": 0
    },
...
},
{
  ...
  "attractions": [
    ...
    {
      "name": {
        "en": "Coral Reef Dive Sites",
        "ar": "مواقع غوص الشعاب المرجانية"
      },
      "type": "nature",
      "entryFee": 0
    }
...
{
  "_id": {
    "$oid": "6a22f1322aff6e43a1ad3c68"
  },
  "name": {
    "en": "Wadi el Gemal National Park",
    "ar": "محمية وادي الجمال"
  },
  "slug": "wadi-el-gemal",
  "city": "Marsa Alam",
  "region": "Red Sea",
...
},
{
  ...
  "attractions": [
    ...
    {
      "name": {
        "en": "Nile-Mediterranean Meeting Point",
        "ar": "ملتقى النيل والبحر المتوسط"
      },
      "type": "landmark",
      "entryFee": 0
    }
...
export const seedDestinations = async () => {
  ...
  console.log
    (`✅ Destinations seeded: ${DESTINATIONS_DATA.length} records across ${[...new Set(DESTINATIONS_DATA.map((d) => d.city))].length
      } cities`);


  try {
    const docsToIndex = DESTINATIONS_DATA.map((doc) =>
      buildDestinationIndexDoc(normalizeSeedDoc(doc))
    );
    ...
    if (indexed) {
      ...
      console.warn("[Seed] Pinecone indexing skipped or failed for destinations");
    }
  } catch (error) {
