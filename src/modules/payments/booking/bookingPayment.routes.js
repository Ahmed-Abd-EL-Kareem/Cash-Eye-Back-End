...
router.post("/pay/intent", protect, bookingPaymentController.createBookingPaymentIntent);
router.post("/intent", protect, bookingPaymentController.createBookingPaymentIntent);
router.post("/booking/pay/intent", protect, bookingPaymentController.createBookingPaymentIntent);
